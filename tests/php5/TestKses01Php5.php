...
//  seriously, we're testing against junk values, so hush.
/** @noinspection HtmlUnknownTarget */

const DS = DIRECTORY_SEPARATOR;
include_once '..'.DS.'..'.DS.'kses.php';

//  Taken from my original tests code to work with PHPUnit
class TestKses01Php5 extends PHPUnit_Framework_TestCase
{
